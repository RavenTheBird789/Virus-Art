...
Python program that imports the turtle module in order to perform math functions to create a green geometric model that appears similar to the shape of a virus
